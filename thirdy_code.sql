...
CREATE TABLE IF NOT EXISTS `mydb`.`hospital_staff` (
  ...
  PRIMARY KEY (`hospsta_id`, `autoclave_autoc_id`),
  ...
  CONSTRAINT `fk_HOSPITAL_STAFF_AUTOCLAVE1`
    ...
    REFERENCES `mydb`.`autoclave` (`autoc_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`office_staff` (
  ...
  PRIMARY KEY (`officesta_id`, `purchase_order_purchase_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`driver_staff` (
  ...
  PRIMARY KEY (`driversta_id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mydb`.`office_staff_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`office_staff_copy1` (
  `officesta_id` INT NOT NULL,
  `officesta_lname` VARCHAR(45) NULL,
  `officesta_fname` VARCHAR(45) NULL,
  `officesta_age` INT NULL,
  ...
  PRIMARY KEY (`officesta_id`, `purchase_order_purchase_id`),
  INDEX `fk_OFFICE_STAFF_PURCHASE_ORDER1_idx` (`purchase_order_purchase_id` ASC) VISIBLE,
  CONSTRAINT `fk_OFFICE_STAFF_PURCHASE_ORDER10`
    FOREIGN KEY (`purchase_order_purchase_id`)
    REFERENCES `mydb`.`purchase_order` (`purchase_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`materials` (
  ...
  CONSTRAINT `fk_MATERIALS_DRIVER_STAFF1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_materials_office_staff_copy11`
    FOREIGN KEY (`office_staff_copy1_officesta_id` , `office_staff_copy1_purchase_order_purchase_id`)
    REFERENCES `mydb`.`office_staff_copy1` (`officesta_id` , `purchase_order_purchase_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`patient` (
  ...
  PRIMARY KEY (`patient_id`, `fee_fee_id`, `sales_invoice_invoice_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`sales_invoice` (
  ...
  PRIMARY KEY (`invoice_id`, `patient_patient_id1`, `patient_fee_fee_id1`, `patient_sales_invoice_invoice_id1`, `patient_patient_id`, `patient_fee_fee_id`, `patient_sales_invoice_invoice_num`),
  ...
  CONSTRAINT `fk_SALES_INVOICE_PATIENT2`
    ...
    REFERENCES `mydb`.`patient` (`patient_id` , `fee_fee_id` , `sales_invoice_invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`assistant_staff` (
  ...
  `sales_invoice_invoice_id` INT NOT NULL,
  PRIMARY KEY (`assiststa_id`, `sales_invoice_invoice_id`),
  ...
  CONSTRAINT `fk_ASSISTANT_STAFF_SALES_INVOICE1`
    ...
    REFERENCES `mydb`.`sales_invoice` (`invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`operation` (
  `operation_room_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`doctor` (
  ...
  `office_staff_officesta_id1` INT NOT NULL,
  PRIMARY KEY (`doc_id`, `materials_mater_num`, `company_comp_id`, `office_staff_officesta_id`, `company_comp_id1`, `assistant_staff_assiststa_id`, `assistant_staff_assiststa_id1`, `operation_operation_room_num`, `office_staff_officesta_id1`),
  ...
  CONSTRAINT `fk_DOCTOR_OPERATION1`
    ...
    REFERENCES `mydb`.`operation` (`operation_room_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_OFFICE_STAFF1`
    FOREIGN KEY (`office_staff_officesta_id1`)
    REFERENCES `mydb`.`office_staff` (`officesta_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`DOCTOR_has_MATERIALS` (
  ...
  CONSTRAINT `fk_DOCTOR_has_MATERIALS_DOCTOR1`
    ...
    REFERENCES `mydb`.`doctor` (`doc_id` , `materials_mater_num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_has_MATERIALS_MATERIALS1`
    FOREIGN KEY (`MATERIALS_MATER_NUM`)
    REFERENCES `mydb`.`materials` (`mater_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`doctor_recieves_materials` (
  ...
  INDEX `fk_DOCTOR_has_MATERIALS1_DOCTOR1_idx` (`doctor_doc_id` ASC, `doctor_materials_mater_num` ASC, `doctor_company_comp_id` ASC, `doctor_office_staff_officesta_id` ASC, `doctor_company_comp_id1` ASC) VISIBLE,
  CONSTRAINT `fk_DOCTOR_has_MATERIALS1_DOCTOR1`
    FOREIGN KEY (`doctor_doc_id` , `doctor_materials_mater_num` , `doctor_company_comp_id` , `doctor_office_staff_officesta_id` , `doctor_company_comp_id1`)
    REFERENCES `mydb`.`doctor` (`doc_id` , `materials_mater_num` , `company_comp_id` , `office_staff_officesta_id` , `company_comp_id1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`doctor_operates_patient` (
  ...
  `patient_patient_id` INT NOT NULL,
  PRIMARY KEY (`doctor_doc_id`, `doctor_materials_mater_id`, `doctor_company_comp_id`, `doctor_office_staff_officesta_id`, `doctor_company_comp_id1`, `doctor_assistant_staff_assiststa_id`, `patient_patient_id`),
  INDEX `fk_DOCTOR_has_PATIENT_PATIENT1_idx` (`patient_patient_id` ASC) VISIBLE,
  INDEX `fk_DOCTOR_has_PATIENT_DOCTOR1_idx` (`doctor_doc_id` ASC, `doctor_materials_mater_id` ASC, `doctor_company_comp_id` ASC, `doctor_office_staff_officesta_id` ASC, `doctor_company_comp_id1` ASC, `doctor_assistant_staff_assiststa_id` ASC) VISIBLE,
  CONSTRAINT `fk_DOCTOR_has_PATIENT_DOCTOR1`
    FOREIGN KEY (`doctor_doc_id` , `doctor_materials_mater_id` , `doctor_company_comp_id` , `doctor_office_staff_officesta_id` , `doctor_company_comp_id1` , `doctor_assistant_staff_assiststa_id`)
    REFERENCES `mydb`.`doctor` (`doc_id` , `materials_mater_num` , `company_comp_id` , `office_staff_officesta_id` , `company_comp_id1` , `assistant_staff_assiststa_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`DOCTOR_RECIEVES_MATERIALS1` (
  ...
  CONSTRAINT `fk_DOCTOR_has_MATERIALS1_DOCTOR2`
    ...
    REFERENCES `mydb`.`doctor` (`doc_id` , `materials_mater_num` , `company_comp_id` , `office_staff_officesta_id` , `company_comp_id1` , `assistant_staff_assiststa_id` , `assistant_staff_assiststa_id1` , `operation_operation_room_num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`DOCTOR_has_MATERIALS1` (
  ...
  CONSTRAINT `fk_DOCTOR_has_MATERIALS1_DOCTOR3`
    ...
    REFERENCES `mydb`.`doctor` (`doc_id` , `materials_mater_num` , `company_comp_id` , `office_staff_officesta_id` , `company_comp_id1` , `assistant_staff_assiststa_id` , `assistant_staff_assiststa_id1` , `operation_operation_room_num` , `office_staff_officesta_id1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`doctor_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`doctor_copy1` (
  `doc_id` INT NOT NULL,
  `doc_lname` VARCHAR(45) NULL,
  `doc_fname` VARCHAR(45) NULL,
  `doc_licen` VARCHAR(45) NULL,
  ...
  INDEX `fk_DOCTOR_OPERATION1_idx` (`operation_operation_room_num` ASC) VISIBLE,
  INDEX `fk_DOCTOR_OFFICE_STAFF1_idx` (`office_staff_officesta_id1` ASC) VISIBLE,
  CONSTRAINT `fk_DOCTOR_COMPANY10`
    FOREIGN KEY (`company_comp_id1`)
    REFERENCES `mydb`.`company` (`comp_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_ASSISTANT_STAFF10`
    FOREIGN KEY (`assistant_staff_assiststa_id`)
    REFERENCES `mydb`.`assistant_staff` (`assiststa_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_ASSISTANT_STAFF20`
    FOREIGN KEY (`assistant_staff_assiststa_id1`)
    REFERENCES `mydb`.`assistant_staff` (`assiststa_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_OPERATION10`
    FOREIGN KEY (`operation_operation_room_num`)
    REFERENCES `mydb`.`operation` (`operation_room_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_OFFICE_STAFF10`
    FOREIGN KEY (`office_staff_officesta_id1`)
    REFERENCES `mydb`.`office_staff` (`officesta_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`doctor_copy2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`doctor_copy2` (
  `doc_id` INT NOT NULL,
  `doc_lname` VARCHAR(45) NULL,
  `doc_fname` VARCHAR(45) NULL,
  `doc_licen` VARCHAR(45) NULL,
  ...
  INDEX `fk_DOCTOR_OPERATION1_idx` (`operation_operation_room_num` ASC) VISIBLE,
  INDEX `fk_DOCTOR_OFFICE_STAFF1_idx` (`office_staff_officesta_id1` ASC) VISIBLE,
  CONSTRAINT `fk_DOCTOR_COMPANY11`
    FOREIGN KEY (`company_comp_id1`)
    REFERENCES `mydb`.`company` (`comp_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_ASSISTANT_STAFF11`
    FOREIGN KEY (`assistant_staff_assiststa_id`)
    REFERENCES `mydb`.`assistant_staff` (`assiststa_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_ASSISTANT_STAFF21`
    FOREIGN KEY (`assistant_staff_assiststa_id1`)
    REFERENCES `mydb`.`assistant_staff` (`assiststa_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_OPERATION11`
    FOREIGN KEY (`operation_operation_room_num`)
    REFERENCES `mydb`.`operation` (`operation_room_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DOCTOR_OFFICE_STAFF11`
    FOREIGN KEY (`office_staff_officesta_id1`)
    REFERENCES `mydb`.`office_staff` (`officesta_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`sales_invoice_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`sales_invoice_copy1` (
  `invoice_id` INT NOT NULL,
  `invoice_date` DATE NULL,
  `bonecements_quant` INT NULL,
  `bonecem_cost` INT NULL,
  ...
  INDEX `fk_SALES_INVOICE_PATIENT2_idx` (`patient_patient_id1` ASC, `patient_fee_fee_id1` ASC, `patient_sales_invoice_invoice_id1` ASC) VISIBLE,
  INDEX `fk_SALES_INVOICE_PATIENT1_idx` (`patient_patient_id` ASC, `patient_fee_fee_id` ASC, `patient_sales_invoice_invoice_num` ASC) VISIBLE,
  CONSTRAINT `fk_SALES_INVOICE_PATIENT20`
    FOREIGN KEY (`patient_patient_id1` , `patient_fee_fee_id1` , `patient_sales_invoice_invoice_id1`)
    REFERENCES `mydb`.`patient` (`patient_id` , `fee_fee_id` , `sales_invoice_invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SALES_INVOICE_PATIENT10`
    FOREIGN KEY (`patient_patient_id` , `patient_fee_fee_id` , `patient_sales_invoice_invoice_num`)
    REFERENCES `mydb`.`patient` (`patient_id` , `fee_fee_id` , `sales_invoice_invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`assistant_staff_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`assistant_staff_copy1` (
  `assiststa_id` INT NOT NULL,
  `assistantsta_lname` VARCHAR(45) NULL,
  `assistantsta_fname` VARCHAR(45) NULL,
  `assistantsta_licen` VARCHAR(45) NULL,
  ...
  `assistantsta_email` VARCHAR(45) NULL,
  `sales_invoice_invoice_id` INT NOT NULL,
  `sales_invoice_copy1_invoice_id` INT NOT NULL,
  `sales_invoice_copy1_patient_patient_id1` INT NOT NULL,
  `sales_invoice_copy1_patient_fee_fee_id1` INT NOT NULL,
  `sales_invoice_copy1_patient_sales_invoice_invoice_id1` INT NOT NULL,
  `sales_invoice_copy1_patient_patient_id` INT NOT NULL,
  `sales_invoice_copy1_patient_fee_fee_id` INT NOT NULL,
  `sales_invoice_copy1_patient_sales_invoice_invoice_num` INT NOT NULL,
  PRIMARY KEY (`assiststa_id`, `sales_invoice_invoice_id`, `sales_invoice_copy1_invoice_id`, `sales_invoice_copy1_patient_patient_id1`, `sales_invoice_copy1_patient_fee_fee_id1`, `sales_invoice_copy1_patient_sales_invoice_invoice_id1`, `sales_invoice_copy1_patient_patient_id`, `sales_invoice_copy1_patient_fee_fee_id`, `sales_invoice_copy1_patient_sales_invoice_invoice_num`),
  INDEX `fk_ASSISTANT_STAFF_SALES_INVOICE1_idx` (`sales_invoice_invoice_id` ASC) VISIBLE,
  INDEX `fk_assistant_staff_copy1_sales_invoice_copy11_idx` (`sales_invoice_copy1_invoice_id` ASC, `sales_invoice_copy1_patient_patient_id1` ASC, `sales_invoice_copy1_patient_fee_fee_id1` ASC, `sales_invoice_copy1_patient_sales_invoice_invoice_id1` ASC, `sales_invoice_copy1_patient_patient_id` ASC, `sales_invoice_copy1_patient_fee_fee_id` ASC, `sales_invoice_copy1_patient_sales_invoice_invoice_num` ASC) VISIBLE,
  CONSTRAINT `fk_ASSISTANT_STAFF_SALES_INVOICE10`
    FOREIGN KEY (`sales_invoice_invoice_id`)
    REFERENCES `mydb`.`sales_invoice` (`invoice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_assistant_staff_copy1_sales_invoice_copy11`
    FOREIGN KEY (`sales_invoice_copy1_invoice_id` , `sales_invoice_copy1_patient_patient_id1` , `sales_invoice_copy1_patient_fee_fee_id1` , `sales_invoice_copy1_patient_sales_invoice_invoice_id1` , `sales_invoice_copy1_patient_patient_id` , `sales_invoice_copy1_patient_fee_fee_id` , `sales_invoice_copy1_patient_sales_invoice_invoice_num`)
    REFERENCES `mydb`.`sales_invoice_copy1` (`invoice_id` , `patient_patient_id1` , `patient_fee_fee_id1` , `patient_sales_invoice_invoice_id1` , `patient_patient_id` , `patient_fee_fee_id` , `patient_sales_invoice_invoice_num`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
